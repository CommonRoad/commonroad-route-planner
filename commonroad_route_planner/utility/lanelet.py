...
def _retrieve_ids_lanelets_goal(
    goal_region, lanelet_network, allowed_lanelet_ids, reach_goal_state: bool
):
        ...
        for idx, state in enumerate(goal_region.state_list):
            if hasattr(state, "position"):
                ...
                list_ids_lanelets_pos_goal = list(
                    _filter_allowed_lanelet_ids(list_ids_lanelets_pos_goal)
                )
